...
const translations = {
  'zh': {
    ...
    'help.step3': '如需使用<strong>地图缺失模式</strong>，请打开「地图缺失模式」开关',
    'help.step4': '选择<strong>出生点</strong>（可跳过）',
    'help.step5': '点选地图上的标记点：标记越多，种子筛选越快；仅剩一个时显示完整种子详情与地图图像',
    'help.principle': '匹配原理',
    'help.principle_basic': '<strong>常规模式</strong>：根据夜王、地形、出生点，以及资源共享点位（教堂、法师塔、祷告屋、马车）的位置信息，快速锁定对应的地图种子',
    'help.principle_advanced': '<strong>地图缺失模式</strong>：基于常规模式，额外根据周围野外 BOSS 和要塞据点的 BOSS 来快速定位当前地图种子',
    'help.basic_mode': '常规模式 · 标记点操作方式',
    'help.basic_pc': '<strong>PC</strong>：<strong>左键点击</strong>点位会直接标记为教堂，<strong>右键点击</strong>可展示完整可标记列表',
    'help.basic_mobile': '<strong>移动端</strong>：<strong>单点</strong>会直接标记为教堂，<strong>长按</strong>可展示完整可标记列表',
    'help.basic_clear': '再次点击已经标记的点位，会取消该点的标记',
    'help.basic_auto_options': '当剩余匹配种子在一定数量内时，会自动展示所有剩余标记点可选项',
    'help.basic_auto_seed': '当筛选出最终地图种子时，会自动展示出该种子',
    'help.advanced_mode': '地图缺失模式 · 标记点操作方式',
    'help.advanced_orange': '橙色圆点：常规模式标记点的点位',
    'help.advanced_yellow': '黄色圆点：野外 BOSS 与要塞据点 BOSS',
    'help.advanced_red': '红色圆点：持秤商人点位',
    'help.advanced_click': '点击要标记的点位进行标记，直到匹配出最终地图种子。再次点击已经标记的点位可取消该点的标记',
    'help.poi_meaning': '标记点图标意义',
    'help.poi_church': '教堂',
    'help.poi_tower': '法师塔',
    ...
    // Image cache (pattern-cache.js)
    'help.cache_title': '图片缓存',
    'help.cache_desc': '种子结果图按需下载并缓存在本机，已缓存在无网络时也可查看',
    'help.cache_stats': '已缓存 {count} 张，约 {size} MB',
    'help.cache_clear': '清除缓存',

    // Seed display
    'seed.click_enlarge': '点击图片放大（双指/滚轮缩放）',
    'seed.loading': '正在加载种子图...',
    'seed.load_error': '图片加载失败，请检查网络后重试',
    'seed.retry': '重试',
  ...
  'en': {
    ...
    'help.step3': 'To use <strong>Map Missing Mode</strong>, turn on the "Map Missing Mode" toggle',
    'help.step4': 'Select a <strong>Spawn Point</strong> (skippable)',
    'help.step5': 'Click POIs (markers) on the map: more marks narrow down seeds faster; when only one remains, full seed details and map image are shown',
    'help.principle': 'Matching Principle',
    'help.principle_basic': '<strong>Normal Mode</strong>: narrows down the map seed using the Nightlord, terrain, spawn point, and the positions of shared resource points (Churches, Mage Towers, Seals, Carriages)',
    'help.principle_advanced': '<strong>Map Missing Mode</strong>: building on Normal Mode, additionally uses nearby Field Bosses and Stronghold Bosses to pinpoint the current seed',
    'help.basic_mode': 'Normal Mode · POI Controls',
    'help.basic_pc': '<strong>PC</strong>: <strong>left-click</strong> a point to mark it as a Church; <strong>right-click</strong> to show the full list of markable types',
    'help.basic_mobile': '<strong>Mobile</strong>: <strong>tap</strong> to mark a Church; <strong>long-press</strong> to show the full list of markable types',
    'help.basic_clear': 'Click an already-marked point again to clear its mark',
    'help.basic_auto_options': 'When the remaining matching seeds drop below a threshold, all remaining POI options are shown automatically',
    'help.basic_auto_seed': 'When narrowed down to a single seed, it is shown automatically',
    'help.advanced_mode': 'Map Missing Mode · POI Controls',
    'help.advanced_orange': 'Orange dot: normal-mode POI points',
    'help.advanced_yellow': 'Yellow dot: Field Bosses and Stronghold Bosses',
    'help.advanced_red': 'Red dot: Scale Merchant points',
    'help.advanced_click': 'Click points to mark them until the final map seed is matched. Click an already-marked point again to clear its mark',
    ...
    // Image cache (pattern-cache.js)
    'help.cache_title': 'Image Cache',
    'help.cache_desc': 'Seed result images are downloaded on demand and cached locally; cached ones work offline',
    'help.cache_stats': '{count} cached, about {size} MB',
    'help.cache_clear': 'Clear cache',

    // Seed display
    'seed.click_enlarge': 'Click image to enlarge (pinch/scroll to zoom)',
    'seed.loading': 'Loading seed map...',
    'seed.load_error': 'Failed to load image, check network and retry',
    'seed.retry': 'Retry',
