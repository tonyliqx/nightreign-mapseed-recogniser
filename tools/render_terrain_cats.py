...
#   2) SPAWN_SCALE = 1                            —— 落地点取基础版 SPAWN_POINTS_BY_MAP(1536)，绝不用坐标.csv 山羊点
import math, os
...
SPAWN_1536 = {
    "Default 默认": [("700", 298.8, 1123.0), ("701", 313.0, 850.8), ("702", 326.8, 559.8),
                     ("703", 492.8, 564.8), ("704", 881.8, 1266.0), ("705", 754.0, 1015.4),
                     ("706", 786.2, 290.4), ("707", 1286.8, 795.4), ("708", 1043.6, 556.4)],
    "Mountaintop 山顶": [("700", 298.8, 1123.0), ("701", 313.0, 850.8), ("704", 881.8, 1266.0),
                        ("705", 754.0, 1015.4), ("706", 786.2, 290.4), ("707", 1286.8, 795.4),
                        ("708", 1043.6, 556.4)],
    "Crater 火山口": [("700", 298.8, 1123.0), ("701", 313.0, 850.8), ("702", 326.8, 559.8),
                     ("704", 881.8, 1266.0), ("705", 754.0, 1015.4), ("707", 1286.8, 795.4),
                     ("708", 1043.6, 556.4)],
    "Rotted Woods 腐败森林": [("700", 298.8, 1123.0), ("701", 313.0, 850.8), ("702", 326.8, 559.8),
                            ("703", 492.8, 564.8), ("706", 786.2, 290.4), ("708", 1043.6, 556.4)],
    "Great Hollow 大空洞": [("13000", 410.0, 1100.0), ("13001", 695.0, 1230.0), ("13002", 1110.0, 437.0)],
    "Noklateo 诺克史黛拉": [("702", 326.8, 559.8), ("703", 492.8, 564.8), ("704", 881.8, 1266.0),
                          ("705", 754.0, 1015.4), ("706", 786.2, 290.4), ("707", 1286.8, 795.4),
                          ("708", 1043.6, 556.4)],
}
...
for tid, tname, slug in TERRAINS:
    ...
    # 红★落地点（基础版 SPAWN 1536）
    for val, x1536, y1536 in SPAWN_1536[tname]:
    ...
    print(f"  落地点图: 红★{len(SPAWN_1536[tname])} / 棕●山羊{len(goat)}")
